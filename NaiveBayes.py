...
accuracytrain = (mnb.predict(features_train)==labels_train).mean()
print(f'Train Accuracy : {accuracytrain*100:2.4f}%')
...
accuracytest = (mnb.predict(features_test)==labels_test).mean()
print(f'Test Accuracy : {accuracytest*100:2.4f}%')
